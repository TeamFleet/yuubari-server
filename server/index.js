...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async app => {
  const target =  false ? 0 : process.env.YUUBARI_LOCAL_RUN ? `https://akigumo.fleet.moe` : `http://localhost:${portAkigumo}`;
  console.log({
    target,
    devPortAkigumo,
    portAkigumo,
