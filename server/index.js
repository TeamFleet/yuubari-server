...
/***/ "./logs/tmp/config/portion.server.1582999592914.js":
/*!*********************************************************!*\
  !*** ./logs/tmp/config/portion.server.1582999592914.js ***!
  \*********************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _KOOT_PROJECT_CONFIG_PORTION_SERVER_PATHNAME___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! __KOOT_PROJECT_CONFIG_PORTION_SERVER_PATHNAME__ */ "./logs/tmp/config/portion.server.1582999592914.js");
...
const getLocalesFull = () => {
  ...
  return locales.map(l => [l[0], fs.readJsonSync( false ? undefined : getLocaleFile(l[3]), 'utf-8'), l[2], l[3]]); // return JSON.parse(process.env.KOOT_I18N_LOCALES);
};
...
const locales = (() => getLocalesObject() || {})();
